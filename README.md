...
Antes de contestar las preguntas, es importante señalar que el comportamiento de el método solve y del método inv tienen rendimientos muy parecidos, por lo que en la mayoría de los casos, las respuestas serán considerando ambas opciones, a no ser que se hable especificamente de cada uno.  
...
Claramente en todos los casos se puede observar que con mayores valroes de N, el tiempo de ensamblaje y de solución aumenta, es interesante señalar que llegado un valor de N bastante grande, las curvas comienzan a tener un comportamiento tipo por lo cual se puede predecir su comportamiento con N mayores. Además es interesante señalar, como en el caso de matrices dispersas, a pesar de tener matrices muy grandes, el tiempo de ejecución sigue siendo bastatne bajo, con lo que se lleva a decir que su comportamiento entre N termina siendo muy similar, tendiendo a rectas constantes y lineales.  
