...
#Abrimos los archivo
fid = open("rendimiento_inv_llenas_caso_3.txt","r")
...
plt.title("Rendimiento Am1 Matrices Llenas")          #Título
...
plt.savefig("Desempeño INV Matrices Llenas", dpi = 300, bbox_inches = 'tight')
...
#Abrimos los archivo
fid = open("rendimiento_inv_dispersas.txt","r")
...
#Gráfico 1
g1 = plt.subplot(2,1,1)
plt.title("Rendimiento Am1 Matrices Dispersas")          #Título
plt.ylabel("Tiempo de ensamblado") #Eje y
...
plt.savefig("Desempeño INV Matrices Dispersas", dpi = 300, bbox_inches = 'tight')
...
#Abrimos los archivo
fid = open("rendimiento_solve_llenas.txt","r")
...
#Gráfico 1
g1 = plt.subplot(2,1,1)
plt.title("Rendimiento SOLVE(A, b) Matrices Llenas")          #Título
plt.ylabel("Tiempo de ensamblado") #Eje y
...
plt.savefig("Desempeño SOLVE Matrices Llenas", dpi = 300, bbox_inches = 'tight')
...
#Abrimos los archivo
fid = open("rendimiento_solve_dispersas.txt","r")
...
#Gráfico 1
g1 = plt.subplot(2,1,1)
plt.title("Rendimiento SOLVE(A, b) Matrices Dispersas")          #Título
plt.ylabel("Tiempo de ensamblado") #Eje y
...
plt.savefig("Desempeño SOLVE Matrices Dispersas", dpi = 300, bbox_inches = 'tight')
